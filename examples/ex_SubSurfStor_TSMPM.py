...
dataRootDir   = '/p/scratch/cslts/tsmpforecast/operational'
datasetName   = 'TSMPForecastEU2021-07-20-12'
procType      = 'postpro'
pressVarName  = 'press'
pressFiles    = [
          f'{dataRootDir}/{datasetName}/{procType}/{pressVarName}.nc']#,
#          f'{dataRootDir}/{datasetName}/{procType}/1983_07/{pressVarName}.nc'
#          ]
maskFile      = f'{dataRootDir}/{datasetName}/{procType}/mask.nc'
sstoragefile  = f'{dataRootDir}/{datasetName}/run/cordex0.11.out.specific_storage.pfb'
porofile      = f'{dataRootDir}/{datasetName}/run/cordex0.11.out.porosity.pfb'
permFileZ     = f'{dataRootDir}/{datasetName}/run/cordex0.11.out.perm_z.pfb'
permFileY     = f'{dataRootDir}/{datasetName}/run/cordex0.11.out.perm_y.pfb'
permFileX     = f'{dataRootDir}/{datasetName}/run/cordex0.11.out.perm_x.pfb'
pflname       = f'{dataRootDir}/{datasetName}/run/coup_oas.tcl'
indicatorfile = f'/p/project/cslts/tsmpforecast/operational/static/ParFlow_SOIL_INDICATOR3_from_EUR03_x1592y1544z15_on_EUR11_x436y424z15.pfb'
slopeFileX    = f'{dataRootDir}/{datasetName}/run/slopex.pfb'
slopeFileY    = f'{dataRootDir}/{datasetName}/run/slopey.pfb'
